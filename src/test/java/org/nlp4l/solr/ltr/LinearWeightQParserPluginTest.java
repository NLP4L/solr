...
public class LinearWeightQParserPluginTest extends SolrTestCaseJ4 {
  ...
  public void testDirectUse() throws Exception {
    ...
    params.add("q", "{!linearWeight}title body").add("fl", "*,score");
  ...
  public void testReRank() throws Exception {
    ...
    params.add("rqq", "{!linearWeight}title body").add("fl","*,score");
    //params.add("debugQuery","true");
    // score = 1 [first pass] + 14 [second pass; (3 * 1 + 4 * 1) * 2 [reRankWeight]]
    assertQ(req(params, "indent", "on"), "*[count(//doc)=1]",
            "//result/doc[1]/str[@name='id'][.='1']",
            "//result/doc[1]/float[@name='score'][.='15.0']"
    );
  }
}
